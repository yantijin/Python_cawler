...
uri_bk = 'https://www.instagram.com/graphql/query/?query_hash=7c16654f22c819fb63d1183034a5162f&variables=%7B%22user_id%22%3A%22324599988%22%2C%22include_chaining%22%3Atrue%2C%22include_reel%22%3Atrue%2C%22include_suggested_users%22%3Afalse%2C%22include_logged_out_extras%22%3Afalse%2C%22include_highlight_reels%22%3Atrue%7D'

headers = {
    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36',
    'cookie': 'mid=W9b6NQAEAAG7cX9J4F_991Hs6kt_; mcd=3; csrftoken=1hIwLYQpdhkeFto5Dp5brhZPYlEKzz8h; ds_user_id=8781212960; sessionid=8781212960%3AzReUtEOn98Mu3X%3A11; rur=PRN; urlgen="{\"2001:da8:204:1117:58e:8fe2:e6f5:d5a0\": 23910}:1gH7at:czXAxsROIv6lkeRLX8j7H_R3VW8"'
}
...
def main(user):
    ...
    html = get_html(url)
    urls = get_urls(html)
    dirpath = r'E:\GIT_repo\{0}'.format(user)
    if not os.path.exists(dirpath):
        os.mkdir(dirpath)
    for i in range(len(urls)):
        try:
            content = get_content(urls[i])
            file_path = r'E:\GIT_repo\{0}\{1}.{2}'.format(user, md5(content).hexdigest(), urls[i][-3:])
